//export const people: any = { name: "John", lastname: "Perez", age: 30 };
export const marcas = [
  ...
  // Declarando una interfaz para gestionar los nodos de la familia
  ...
  // Implementando la interfaz y creando el nodo de familia
  export const arbolFamilia: Familia[] = [
    {
      id: 1,
      name: "Carlos",
      familia: [
